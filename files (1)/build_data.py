...
FIELD_KEYWORDS = [
 ...
 ("hosp",     ["chef","cook","waiter","waitress","waiting staff","bar staff","bar person","catering","kitchen","hospitality","publican","barista","restaurant","hairdress","barber","beautician","beauty","nail technician","fitness","sports coach","leisure","spa ","conference","exhibition","events manager"]),
...
FIELD_NAME = {
 "health":"Health and Nursing","care":"Social Care & Emergency Services","it":"IT and Technology","data":"Data and Analytics",
 ...
 "sci":"Science and Research","creative":"Creative and Media","consulting":"Consulting & Management",
...
def desc_for(name):
    n=str(name).lower()
    if n in ROLE_DESC: return ROLE_DESC[n]
...
# --- explicit per-occupation routing overrides, exclusions and descriptions ---
ROLE_FIELD_OVERRIDE = {"coffee shop workers": "hosp", "debt, rent and other cash collectors": "admin", "project support officers": "admin", "financial managers and directors": "fin", "purchasing managers and directors": "fin", "social services managers and directors": "care", "senior officers in fire, ambulance, prison and related services": "care", "police officers (sergeant and below)": "care", "it managers": "it", "it network professionals": "it", "cad, drawing and architectural technicians": "eng", "other skilled trades": "maint", "functional managers and directors": "consulting", "chief executives and senior officials": "consulting", "it business analysts, architects and systems designers": "it", "officers in armed forces": "care", "senior police officers": "care", "police officers (inspectors and above)": "care"}
EXCLUDE_ROLES = set(["elected officers and representatives"])
ROLE_DESC = {"records clerks and assistants": "Maintain and organise an organisation's records, files and databases so information can be found quickly.", "other administrative occupations": "Handle general office administration — correspondence, data entry, scheduling and clerical support.", "receptionists": "Greet visitors, answer calls and handle front-desk enquiries as the first point of contact for an organisation.", "financial administrative occupations": "Process invoices, payments and financial paperwork, keeping accounts and records accurate.", "residential, day and domiciliary care managers and proprietors": "Run care homes or home-care services, overseeing staff, budgets and the quality of care provided.", "managers in storage and warehousing": "Oversee warehouse operations, stock, staff and the safe, efficient storage and dispatch of goods.", "property, housing and estate managers": "Manage residential or commercial property — tenancies, maintenance, lettings and estate upkeep.", "bank and post office clerks": "Serve customers with everyday banking and postal transactions, payments and account queries.", "stock control clerks and assistants": "Track inventory levels, record stock movements and reorder supplies to keep operations running.", "coffee shop workers": "Prepare and serve coffee, drinks and light food, and look after customers in a café setting.", "book-keepers, payroll managers and wages clerks": "Record financial transactions and run payroll, keeping accounts and staff pay accurate and on time.", "business and financial project management professionals": "Plan and manage business or financial projects, coordinating budgets, timelines and stakeholders.", "finance and investment analysts and advisers": "Analyse financial data and markets to advise on investments, funding and business decisions.", "business associate professionals": "Provide business support across operations, analysis and administration in a range of sectors.", "health and safety managers and officers": "Make sure workplaces meet health-and-safety law, assessing risks and preventing accidents.", "financial accounts managers": "Oversee an organisation's accounts, reporting and financial controls, often managing a finance team.", "taxation experts": "Advise on tax, prepare returns and help individuals or businesses stay compliant and tax-efficient.", "financial and accounting technicians": "Support accountants with bookkeeping, reconciliations and preparing financial statements.", "chartered and certified accountants": "Prepare and audit accounts, advise on finances and ensure reporting meets professional standards.", "project support officers": "Provide administrative and coordination support to projects — scheduling, documentation and tracking progress.", "chefs": "Prepare and cook food in kitchens, developing dishes and overseeing food quality and safety.", "kitchen and catering assistants": "Support chefs by preparing ingredients, plating food and keeping the kitchen clean and stocked.", "waiters and waitresses": "Take orders and serve food and drink, looking after diners throughout their visit.", "bar staff": "Serve drinks, handle payments and look after customers in pubs, bars and venues.", "catering and bar managers": "Run the catering or bar side of a venue — staff, stock, service standards and budgets.", "cleaning and housekeeping managers and supervisors": "Oversee cleaning and housekeeping teams, keeping premises hygienic and well-presented.", "sports coaches, instructors and officials": "Train and guide people in sport and fitness, or officiate at sporting events.", "events managers and organisers": "Plan and run events — conferences, exhibitions and functions — from logistics to delivery on the day.", "bar and catering supervisors": "Supervise bar or catering staff during service, ensuring smooth running and good customer care.", "beauticians and related occupations": "Provide beauty treatments such as skincare, nails and makeup, advising clients on their care.", "sales accounts and business development managers": "Win and grow client accounts, building relationships and driving new business.", "business sales executives": "Sell products or services to other businesses, managing leads and closing deals.", "marketing, sales and advertising directors": "Lead an organisation's marketing, sales and advertising strategy at a senior level.", "estate agents and auctioneers": "Value, market and sell or let property, or conduct auctions of goods and assets.", "sales administrators": "Process orders and support the sales team with quotes, records and customer follow-up.", "vehicle and parts salespersons and advisers": "Sell vehicles or parts and advise customers on options, finance and specifications.", "telephone salespersons": "Sell products or services over the phone and handle customer orders and enquiries.", "roundspersons and van salespersons": "Sell and deliver goods on a set round or route directly to customers.", "elementary sales occupations": "Carry out basic sales tasks such as promotions, sampling and assisting customers.", "delivery drivers and couriers": "Deliver parcels, food and goods to homes and businesses, planning routes and handling drop-offs.", "warehouse operatives": "Pick, pack, load and store goods in a warehouse, keeping stock moving accurately.", "mobile machine drivers and operatives": "Operate mobile plant and machinery to move materials on sites and in yards.", "transport and distribution clerks and assistants": "Handle the paperwork and coordination behind moving and delivering goods.", "road transport drivers": "Drive vehicles to transport goods or passengers by road, safely and to schedule.", "fork-lift truck drivers": "Operate fork-lift trucks to move and stack goods safely in warehouses and yards.", "managers in transport and distribution": "Plan and oversee transport and distribution operations, fleets, routes and teams.", "other drivers and transport operatives": "Carry out driving and transport work across a range of vehicles and settings.", "bus and coach drivers": "Drive buses or coaches, carrying passengers safely along routes and schedules.", "managers in logistics": "Coordinate the supply chain — warehousing, transport and distribution — to move goods efficiently.", "metal working production and maintenance fitters": "Assemble, install and repair metal machinery and equipment in production and maintenance settings.", "plumbers and heating and ventilating installers and repairers": "Install and repair plumbing, heating and ventilation systems in homes and buildings.", "launderers, dry cleaners and pressers": "Clean, press and finish clothing and textiles in laundries and dry-cleaning services.", "skilled metal, electrical and electronic trades supervisors": "Supervise skilled trades teams working on metal, electrical and electronic equipment.", "welding trades": "Join and cut metal using welding techniques for construction, manufacturing and repair.", "industrial cleaning process occupations": "Carry out specialist industrial cleaning of plant, machinery and work areas.", "electrical service and maintenance mechanics and repairers": "Service and repair electrical equipment and appliances to keep them running safely.", "security system installers and repairers": "Install and maintain alarms, CCTV and other security systems.", "elementary process plant occupations": "Carry out basic operating and support tasks in process and production plants.", "farm workers": "Carry out practical farm work — crops, livestock and machinery — in agriculture.", "vehicle technicians, mechanics and electricians": "Service, diagnose and repair vehicles, including engines, electrics and mechanical systems.", "electricians and electrical fitters": "Install, test and repair electrical wiring and systems in buildings and equipment.", "estimators, valuers and assessors": "Work out the likely cost, value or risk of projects, property or claims.", "elementary construction occupations": "Carry out basic labouring and support tasks on construction sites.", "construction operatives": "Perform hands-on building work on site, from groundwork to structures.", "carpenters and joiners": "Make, install and repair wooden structures and fittings for buildings.", "construction and building trades": "Carry out skilled building-trades work on construction and renovation projects.", "construction project managers and related professionals": "Plan and run construction projects, managing budgets, teams, safety and timelines.", "painters and decorators": "Prepare and finish surfaces with paint, wallpaper and coatings in homes and buildings.", "construction and building trades supervisors": "Supervise building-trades teams on site, keeping work on schedule and to standard.", "it business analysts, architects and systems designers": "Analyse business needs and design IT systems and software architecture to meet them.", "financial managers and directors": "Lead an organisation's finances — planning, reporting, controls and strategy — at a senior level.", "management consultants and business analysts": "Advise organisations on how to improve performance, strategy, processes and operations.", "quality assurance and regulatory professionals": "Make sure products, services and processes meet quality standards and regulations.", "functional managers and directors": "Lead a business function or department, setting direction and managing teams and resources.", "purchasing managers and directors": "Lead procurement — sourcing suppliers, negotiating contracts and controlling spend.", "chief executives and senior officials": "Set the overall direction and strategy of an organisation at the most senior level.", "social services managers and directors": "Lead social-care and social-work services, managing teams, budgets and safeguarding.", "senior officers in fire, ambulance, prison and related services": "Lead teams in the fire, ambulance, prison and related emergency and public-protection services.", "programmers and software development professionals": "Design, write and test the code behind applications, websites and systems.", "information technology professionals": "Build, run and support IT systems, software and infrastructure across an organisation.", "cyber security professionals": "Protect systems and data from cyber threats, monitoring, testing and responding to attacks.", "it project managers": "Plan and deliver IT projects, coordinating teams, budgets and timelines.", "information technology directors": "Lead an organisation's IT strategy, systems and teams at a senior level.", "database administrators and web content technicians": "Manage databases and website content, keeping data organised, secure and available.", "web design professionals": "Design and build websites, shaping how they look, work and feel for users.", "it managers": "Manage IT teams, systems and services to keep technology running and aligned with the organisation's needs.", "it network professionals": "Design, build and maintain the networks that connect an organisation's computers and systems.", "production managers and directors in manufacturing": "Oversee manufacturing operations, planning production, staff, quality and output.", "food, drink and tobacco process operatives": "Operate machinery and processes to produce food, drink and related products.", "routine inspectors and testers": "Check products and materials against standards to catch faults before they ship.", "mining and quarry workers and related operatives": "Extract and process minerals, coal and stone in mines and quarries.", "plant and machine operatives": "Operate industrial plant and machinery to manufacture and process goods.", "other skilled trades": "Carry out skilled trades work spanning several crafts and manual specialisms.", "assemblers and routine operatives": "Assemble products and carry out routine production-line tasks.", "planning, process and production technicians": "Support manufacturing by planning workflows and improving production processes.", "assemblers (vehicles and metal goods)": "Assemble vehicles and metal products on production lines to set specifications.", "chemical and related process operatives": "Operate processes and equipment to make chemicals and related products.", "mechanical engineers": "Design, develop and test mechanical systems, machines and components.", "engineering professionals": "Apply engineering principles to design, build and improve products and systems.", "engineering technicians": "Support engineers by building, testing and maintaining equipment and prototypes.", "civil engineers": "Design and oversee construction of infrastructure like roads, bridges and buildings.", "electrical engineers": "Design and develop electrical systems, equipment and power infrastructure.", "engineering project managers and project engineers": "Plan and deliver engineering projects, coordinating design, build and budgets.", "production and process engineers": "Improve manufacturing processes to make production more efficient and reliable.", "quality control and planning engineers": "Ensure engineering output meets quality standards and plan production to spec.", "building and civil engineering technicians": "Support civil and building engineering projects with technical and site work.", "aerospace engineers": "Design, build and test aircraft, spacecraft and their systems.", "cad, drawing and architectural technicians": "Produce technical drawings and CAD models for engineering, building and architectural projects.", "human resources and industrial relations officers": "Handle HR matters like recruitment, employee relations and policy for an organisation.", "human resource managers and directors": "Lead HR strategy — people, culture, recruitment and employment practices.", "human resources administrative occupations": "Provide administrative support to HR, handling records, contracts and processes.", "advertising and marketing associate professionals": "Support marketing and advertising campaigns, from content to coordination and analysis.", "marketing and commercial managers": "Lead marketing and commercial activity, shaping strategy, campaigns and growth.", "public relations professionals": "Manage an organisation's reputation and communications with media and the public.", "advertising accounts managers and creative directors": "Manage advertising accounts or lead creative direction on campaigns.", "public relations and communications directors": "Lead PR and communications strategy at a senior level.", "research and development (randd) managers": "Lead research and development projects that create new products, methods or knowledge.", "social and humanities scientists": "Research human behaviour, society and culture to produce insight and evidence.", "electrical and electronics technicians": "Build, test and maintain electrical and electronic equipment and systems.", "physical scientists": "Study physics, materials and the physical world through research and experiment.", "chemical scientists": "Research and develop chemicals, materials and processes in labs and industry.", "solicitors and lawyers": "Advise clients on the law, prepare legal documents and represent them in legal matters.", "legal professionals": "Provide qualified legal expertise across advice, casework and representation.", "legal associate professionals": "Support qualified lawyers with casework, research and legal administration.", "legal secretaries": "Provide specialist secretarial support in legal settings, preparing documents and managing cases.", "primary education teaching professionals": "Teach children at primary level across the curriculum, planning lessons and tracking progress.", "higher education teaching professionals": "Teach and research at university level, lecturing and supervising students.", "education managers": "Lead schools, colleges or education services, managing staff, standards and budgets.", "education advisers and school inspectors": "Advise on and inspect education quality, helping schools and services improve.", "customer service occupations": "Help customers with questions, orders and problems across phone, email and in person.", "call and contact centre occupations": "Handle customer calls and messages in a contact centre, resolving queries and requests.", "customer service supervisors": "Lead customer-service teams, handling escalations and maintaining service standards.", "photographers, audio-visual and broadcasting equipment operators": "Capture images and operate audio-visual and broadcast equipment for media and events.", "arts officers, producers and directors": "Plan and produce arts, film, TV or theatre projects, guiding creative and practical delivery.", "graphic and multimedia designers": "Create visual designs for print, screen and multimedia, from branding to layouts.", "design occupations": "Design products, visuals or experiences across a range of creative fields.", "managers and directors in the creative industries": "Lead creative businesses and projects in media, arts, design and entertainment.", "actors, entertainers and presenters": "Perform, present or entertain audiences on stage, screen or in live settings.", "clothing, fashion and accessories designers": "Design clothing, footwear and accessories, from concept to finished product.", "artists": "Create original works of art across painting, illustration and other media.", "sports players": "Compete professionally in sport, training and performing at a high level.", "musicians": "Perform, compose or record music across genres and settings.", "dental nurses": "Support dentists during treatment, preparing patients, instruments and records.", "medical and dental technicians": "Provide technical support in medical and dental care, from lab work to equipment.", "veterinarians": "Diagnose and treat animals' illnesses and injuries and advise on their care.", "dental practitioners": "Diagnose and treat patients' teeth and gums, carrying out dental procedures.", "veterinary nurses": "Care for animals and assist vets during treatment and surgery.", "complementary health associate professionals": "Provide complementary therapies such as massage, acupuncture and holistic care.", "dispensing opticians": "Fit and supply glasses and contact lenses based on prescriptions and advice.", "pharmacy and optical dispensing assistants": "Assist in pharmacies and opticians, dispensing prescriptions and serving customers.", "shopkeepers and owners - retail and wholesale": "Run retail or wholesale shops, managing stock, staff, sales and customers.", "debt, rent and other cash collectors": "Collect outstanding debts, rent and payments, keeping records and arranging repayment.", "market and street traders and assistants": "Sell goods from market stalls and street pitches directly to the public.", "visual merchandisers and related occupations": "Design shop displays and layouts to present products attractively and boost sales.", "houseparents and residential wardens": "Care for and supervise residents in residential homes and supported housing.", "protective service associate professionals": "Support protective and public-safety services that keep people and communities safe.", "animal care services occupations": "Look after animals' welfare in kennels, shelters, grooming and related services.", "fire service officers (watch manager and below)": "Respond to fires and emergencies, protect the public and lead firefighting crews.", "non-commissioned officers and other ranks": "Serve in the armed forces, carrying out operations, training and support duties.", "police community support officers": "Support policing in the community, tackling anti-social behaviour and reassuring the public.", "police officers (sergeant and below)": "Keep communities safe by preventing and investigating crime and responding to emergencies.", "actuaries, economists and statisticians": "Use maths, economics and statistics to model risk, analyse trends and inform decisions.", "data analysts": "Turn data into insight, analysing figures and building reports to guide decisions.", "production managers and directors in mining and energy": "Lead production operations in mining and energy, overseeing sites, safety and output.", "officers in armed forces": "Lead and command personnel in the armed forces, planning and directing operations and training.", "senior police officers": "Lead policing at a senior level, directing operations, strategy and teams to keep communities safe.", "police officers (inspectors and above)": "Lead policing teams and operations at inspector level and above, overseeing frontline work."}

def assign_field(name, soc=""):
    n = (name or "").lower()
    _cn = clean_name(name).lower()
    if _cn in EXCLUDE_ROLES: return None
    if _cn in ROLE_FIELD_OVERRIDE: return ROLE_FIELD_OVERRIDE[_cn]
    if "armed forces" in n or ("police" in n and ("senior" in n or "inspector" in n)): return "care"
...
def build(xbytes, ashe=None):
    ...
    for fk in FIELD_NAME:
        ...
        top=sorted(occ_latest[fk].items(), key=lambda kv: kv[1], reverse=True)[:10]
